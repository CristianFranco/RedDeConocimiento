...
<div class= "col s2 offset-s10">
		...
		<form action="./resultadosDeBusqueda.php" method="POST" id='subFor'>
			<div class="input-field" >
				<label class="icoP" for="nombre">Búsqueda por nombre de grupo o persona:</label>
				<input class="inpP" type="text" id="nombre" name="nombre" ></input>
			</div>

			<div class="input-field" >
			<label class="icoP" for="area">Búsqueda por área  de conocimiento:</label>
			...
			<div class="input-field" >
			<label class="icoP" for="tags">Búsqueda  por contenido de publicaciones:</label>
